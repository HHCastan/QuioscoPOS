...
public class Prueba {
	public static void main(String[] args) {
		System.out.println("Iniciando Quiosco...");
		 ...
		 String tramaIN = "71746198~|jdbc:jtds:sqlserver://172.16.83.55:1433/INFORMESPOS;user=saldospos;password=saldospos;;instance=SQL08|net.sourceforge.jtds.jdbc.Driver|EXECUTE PRC_FACTURA_ELECTRONICA_CLIENTE_APTO|VoucherFEClienteApto_copiaCliente";
